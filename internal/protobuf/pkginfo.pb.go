...
type CachedPackages struct {
	...
	Packages      []*PkgInfo             `protobuf:"bytes,2,rep,name=packages,proto3" json:"packages,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CachedPackages) Reset() {
	*x = CachedPackages{}
...
func (x *CachedPackages) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CachedPackages) ProtoMessage() {}

func (x *CachedPackages) ProtoReflect() protoreflect.Message {
	mi := &file_protobuf_pkginfo_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CachedPackages.ProtoReflect.Descriptor instead.
func (*CachedPackages) Descriptor() ([]byte, []int) {
	return file_protobuf_pkginfo_proto_rawDescGZIP(), []int{2}
}

func (x *CachedPackages) GetLastModified() int64 {
	if x != nil {
...
func (x *CachedPackages) GetPackages() []*PkgInfo {
	if x != nil {
		return x.Packages
	}
	return nil
...
const file_protobuf_pkginfo_proto_rawDesc = "" +
	...
	"\tconflicts\x18\f \x03(\v2\x11.pkginfo.RelationR\tconflicts\"c\n" +
	"\x0eCachedPackages\x12#\n" +
	"\rlast_modified\x18\x01 \x01(\x03R\flastModified\x12,\n" +
	"\bpackages\x18\x02 \x03(\v2\x10.pkginfo.PkgInfoR\bpackages*[\n" +
	"\n" +
	"RelationOp\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
...
var (
	...
	file_protobuf_pkginfo_proto_goTypes   = []any{
		...
		(*CachedPackages)(nil), // 3: pkginfo.CachedPackages
	}
)
...
var file_protobuf_pkginfo_proto_depIdxs = []int32{
	...
	2, // 5: pkginfo.CachedPackages.packages:type_name -> pkginfo.PkgInfo
