...
func PrintHelp() {
	...
	fmt.Println("\nFiltering Options:")
	fmt.Println("  -w, --where <field>=<value> Apply filters to refine package listings. Can be used multiple times.")
	...
	fmt.Println("  yaylog -w reason=explicit         # Show all explicitly installed packages")
